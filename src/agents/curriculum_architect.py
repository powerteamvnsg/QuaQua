...
CURRICULUM_DATABASE = {
    "at_family": {
        "subject": "phonics",
        "domain": "Literacy",
        "skill_type": "word_family_sorting",
        "primary_skill": "CVC Word Family (-at)",
        "words": ["cat", "hat", "bat", "mat", "rat", "sat", "fat", "pat", "vat"],
        "target_sound": "-at",
        "word_families": ["-at"],
        "onset_set": ["c", "h", "b", "m", "r", "s", "f", "p", "v"],
    },
    "beginning_sounds": {
        "subject": "phonics",
        "domain": "Literacy",
        "skill_type": "initial_phoneme_isolation",
        "primary_skill": "Initial Phoneme Isolation",
        "words": ["bat", "bed", "bug", "dog", "doll", "dad", "cat", "cup", "kit"],
        "target_sounds": ["/b/", "/d/", "/k/"],
        "sound_groups": {
            "/b/": ["bat", "bed", "bug"],
            "/d/": ["dog", "doll", "dad"],
    ...
    "rhyme_matching": {
        "subject": "phonics",
        "domain": "Literacy",
        "skill_type": "final_phoneme_isolation",
        "primary_skill": "End-Sound Matching",
        "words": ["cat", "bat", "sun", "run", "dog", "log"],
        "pairs": [("cat", "bat"), ("sun", "run"), ("dog", "log")],
    },
    "digraphs": {
        "subject": "phonics",
        "domain": "Literacy",
        "skill_type": "digraph_sorting",
        "primary_skill": "Digraph Recognition (Sh, Ch, Th, Wh)",
        "words": ["ship", "shop", "fish", "chip", "chop", "rich", "this", "that", "moth"],
        "digraphs": ["/sh/", "/ch/", "/th/"],
        "sound_groups": {
            "/sh/": ["ship", "shop", "fish"],
            "/ch/": ["chip", "chop", "rich"],
    ...
    "subitizing_1": {
        "subject": "math",
        "domain": "Math",
        "skill_type": "subitizing",
        "primary_skill": "Instant Quantity Recognition (1-5)",
        "number_sets": [2, 3, 4, 5],
        "patterns": ["dice", "linear", "irregular"],
    },
    "part_part_whole": {
        "subject": "math",
        "domain": "Math",
        "skill_type": "part_part_whole",
        "primary_skill": "Number Decomposition to 10",
        "total": 10,
        "known_parts": [6, 7, 8, 3, 4],
    },
    "math_addition": {
        "subject": "math",
        "domain": "Math",
        "skill_type": "concrete_addition",
        "primary_skill": "Concrete Addition (to 10)",
        "equations": ["3+2=5", "4+4=8", "6+1=7", "5+3=8", "2+7=9"],
    },
    "middle_vowels": {
        "subject": "phonics",
        "domain": "Literacy",
        "skill_type": "middle_vowel_identification",
        "primary_skill": "Medial Vowel Discrimination",
        "words": ["hat", "hit", "hot", "map", "mop", "pin", "pan"],
        "vowels": ["/a/", "/i/", "/o/"],
    },
}
